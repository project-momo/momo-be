...
# 도커 run
docker run -d -p 8080:8080 -e DB_URL=jdbc:mysql://rdsinstance.cg6o3rqphy1s.ap-northeast-2.rds.amazonaws.com:3306/rdsDB?serverTimezone=Asia/Seoul -v /home/ec2-user:/config --name momo momoadmin/momo:1.0
