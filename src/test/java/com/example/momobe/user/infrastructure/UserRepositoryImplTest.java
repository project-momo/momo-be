...
class UserRepositoryImplTest {
    ...
    void findUserByEmail_exception() {
        //given
        em.persist(new User(EMAIL1, NICKNAME1, PASSWORD1, passwordEncoder, new Avatar(REMOTE_PATH)));
        em.persist(new User(EMAIL1, NICKNAME2, PASSWORD2, passwordEncoder, new Avatar(REMOTE_PATH)));
    ...
    void findUserByEmail_success() {
        //given
        User user = new User(EMAIL1, NICKNAME1, PASSWORD1, passwordEncoder, new Avatar(REMOTE_PATH));
        em.persist(user);
