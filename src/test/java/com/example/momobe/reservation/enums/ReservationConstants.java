...
public class ReservationConstants {
    private static final LocalTime START_TIME = LocalTime.of(1, 0);
    private static final LocalTime END_TIME = LocalTime.of(5, 0);

    public static Reservation generateAcceptReservation(Long userId, Long meetingId) {
        return new Reservation(new ReservationDate(LocalDate.now(), START_TIME, END_TIME), new Money(5000L),
